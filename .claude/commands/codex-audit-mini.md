...
Follow the instructions in `.claude/commands/shared/model-selection.md` to discover available models and present choices.
...
AskUserQuestion:
  ...
  options:
    ...
    - label: "Audit anyway"
      description: "Run the mini audit regardless"
```
